...
export default function ExecutiveDashboard() {
  ...
  const fetchExecutiveData = async () => {
    try {
      ...
      setKpiMetrics([
        {
          ...
          icon: Users,
          color: 'text-blue-600',
          description: 'Aktive brukere i dag'
        },
        {
        ...
        },
        {
          ...
          description: 'Opp 15.3% fra forrige måned'
        },
        {
          title: 'System Uptime',
          value: '99.9%',
        ...
        },
        {
          ...
          icon: Shield,
          color: 'text-red-600',
          description: 'Ned 15.2% fra forrige uke'
        }
      ])
      ...
      setUserActivity([
        { timestamp: '00:00', users: 45, vergeUsers: 12, adminUsers: 3, aiRequests: 23 },
        { timestamp: '04:00', users: 38, vergeUsers: 8, adminUsers: 2, aiRequests: 18 },
        { timestamp: '08:00', users: 156, vergeUsers: 45, adminUsers: 8, aiRequests: 89 },
        { timestamp: '12:00', users: 324, vergeUsers: 78, adminUsers: 15, aiRequests: 234 },
        { timestamp: '16:00', users: 287, vergeUsers: 65, adminUsers: 12, aiRequests: 198 },
        { timestamp: '20:00', users: 189, vergeUsers: 42, adminUsers: 7, aiRequests: 156 }
      ])
      ...
      setAiAnalytics({
        ...
        requestsByHour: [
          { hour: '00:00', requests: 23 },
          { hour: '04:00', requests: 18 },
          { hour: '08:00', requests: 89 },
          { hour: '12:00', requests: 234 },
          { hour: '16:00', requests: 198 },
          { hour: '20:00', requests: 156 }
        ]
      })
